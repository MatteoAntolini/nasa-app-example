        ...
        builder: (context) => Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(children: [
                    ...
                    TextSpan(
                        text: Strings.BOUNDARIES, style: Styles.HEADING_STYLE)
                  ]),
                ),
              ),
              SizedBox(height: 12),
              ...
              SizedBox(height: 12),
              Text(context.watch<ApodCubit>().state.toString() == ""
                  ? ""
                  : ""), //BUG di bloc. A qunato pare il bloc non viene aggiornato con il listener
