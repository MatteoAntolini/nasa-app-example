...
class Styles {
  static TextStyle TITLE_STYLE = GoogleFonts.openSans(
      color: text86, fontSize: 36, fontWeight: FontWeight.w800);

  static TextStyle F1TITLE_STYLE = GoogleFonts.openSans(
      color: WHITEF1, fontSize: 36, fontWeight: FontWeight.w800);

  static TextStyle HEADING_STYLE = GoogleFonts.openSans(
      color: text80, fontSize: 36, fontWeight: FontWeight.w600);

  static TextStyle F1HEADING_STYLE = GoogleFonts.openSans(
      color: WHITEF1, fontSize: 36, fontWeight: FontWeight.w600);
  ...
  static TextStyle H2_STYLE = GoogleFonts.openSans(
      color: text70, fontSize: 22, fontWeight: FontWeight.bold);

  static TextStyle F1H2_STYLE = GoogleFonts.openSans(
  ...
  static TextStyle DARK_PRIMARY_HEADING = GoogleFonts.openSans(
      color: PRIMARY_LIGHT, fontSize: 22, fontWeight: FontWeight.bold);
